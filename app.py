...
def predict():
   ...
   path=r'C:\Users\pranj\OneDrive\Desktop\download_music_bot\temp.wav';
   file.save(path)
   

   #reloading saved model
   reloaded_model = tf.saved_model.load(r'C:\Users\pranj\OneDrive\Desktop\noise_bot_flask\noisy_boy_deployment\noise_bot_model')
   
   # Load a WAV file, convert it to a float tensor, resample to 16 kHz single-channel audio
   def load_wav_16k_mono():
    
    file_contents = tf.io.read_file(r'C:\Users\pranj\OneDrive\Desktop\download_music_bot\temp.wav')
